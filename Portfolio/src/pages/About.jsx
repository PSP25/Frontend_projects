      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-3/4 md:pl-6">
          ...
          <div className="pl-2">
            ...
            <p className="mt-4 text-lg leading-relaxed">
              📚 <strong>Academics & More:</strong> Priyanshu maintains an impressive CGPA of <strong>8.93/10.00</strong>, complemented by coursework in Data Structures and Algorithm (DSA), Object-Oriented Programming (OOP), Database Management Systems (DBMS), Operating Systems (OS), and Computer Networks (CN) from prestigious platforms.
            </p>
            <p className="mt-4 text-lg leading-relaxed">
